...
function createAboutUsPage() {
  ...
  const introContent = new CustomElement('p', {
    ...
    В своей работе мы использовали следующие инструменты разработки: TypeScript, Webpack, SASS, EsLint, Prettier, StyleLint, Canvas, Chart.js, Git, GitHub-actions.</p>
